...
.news_main .news_02 h3{font-size:0.4rem;color:#000;height: 1.2rem;overflow: hidden;line-height:0.56rem;width:5.8rem;overflow: hidden;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;}
