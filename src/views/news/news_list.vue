...
.news_main .news_02 h3{font-size:0.4rem;color:#000;height: 1.2rem;overflow: hidden;line-height:0.56rem;width:6.02rem;overflow: hidden;}
.news_main .news_02 p{font-size:0.28rem;color:#959595;height:1rem;overflow: hidden;line-height:0.5rem; }
