    ...
    <div class="news_main">
      ...
      <div class="news_02" v-for="(item,index) in news" :key="index">
        ...
        <div class="right">
          ...
          <p>
            <router-link :to="{name:'newsdetail', params:{id:item.id}}">{{item.description.trim()}}</router-link>
          </p>
      ...
      <div class="index-more" v-show="pagemore">
        <span>more</span>
...
.news_main .news_02 .left {
  width: 3.6rem;
  height: 2.56rem;
}
.news_main .news_02 .left img {
  width: 3.6rem;
  height: 2.56rem;
}
.news_main .news_02 .right {
  width: 6.02rem;
  height: 2.56rem;
  display: flex;
  align-items: left;
...
.news_main .news_02 .right h3 a {
  color: #000;
}
.news_main .news_02 h3 {
  font-size: 0.4rem;
  color: #000;
  max-height: 1.2rem;
  overflow: hidden;
...
.news_main .news_02 p a {
  color: #959595;
}
.news_main .news_02 .date {
  font-size: 0.28rem;
  color: #959595;
  margin: 0.2rem 0 0;
  position: absolute;
