            ...
            <div class="book-list">
              <ul v-if="list1.length>0">
                <li v-for="(item,index) in list1" :key="index">
                  <div class="date" @click="tobookingxq(item)">
                    <router-link to="#">
                      <span>{{list1[index].date}}</span>
                      <i>{{list1[index].moth}}月</i>
                    </router-link>
                  </div>
                  ...
                  <div class="date_03">
                    <div class="isNew" v-show="item.is_new==1">
                      <img src="../../assets/images/news-icon.jpg" alt />
                    </div>
              ...
              <van-popup v-model="show_right">
                <div class="good">
                  <img
                    ...
                    alt
                    style="width:1.05rem;height:0.95rem;"
                  />
                  <p style="color:#000;font-size:0.4rem;">{{$t('m.others12')}}</p>
                </div>
              </van-popup>
              <div class="index-more" v-show="this.list1.length>6">
                <span>more</span>
        ...
        <van-tab :title="$t('m.others6')">
          ...
          <div class="booking">
            <div class="book-list">
                ...
                <li v-for="(item,index) in list2" :key="index">
                  <div class="date">
                    <router-link :to="{name:'bookingfeedback',params:{id:item.id}}">
                      <span>{{list2[index].date}}</span>
                      <i>{{list2[index].moth}}月</i>
                    </router-link>
                  </div>
                  <div class="date_02">
                    <router-link :to="{name:'bookingfeedback',params:{id:item.id}}">
                  ...
                  <div class="date_03">
                    ...
                    <div class="total-button">
                      <van-button
                        ...
                        class="s11"
                        @click="toCallPhone(item.mobile)"
                      >{{$t('m.others9')}}</van-button>
                      <router-link :to="{name:'bookingfeedback',params:{id:item.id}}">
                        <van-button class="s22">{{$t('m.others10')}}</van-button>
                      </router-link>
                    </div>
                  </div>
                </li>
              ...
              <div class="index-more" v-show="this.list2.length>6">
                <span>more</span>
                <img src="../../assets/images/more-icon.jpg" alt />
              </div>
            </div>
        ...
        <van-tab :title="$t('m.others7')">
          ...
          <div class="booking">
            <div class="book-list">
                ...
                <li v-for="(item,index) in list3" :key="index">
                  <div class="date">
                    <router-link :to="{name:'feedbackdetail',params:{id:item.id}}">
                      <span>{{list3[index].date}}</span>
                      <i>{{list3[index].moth}}{{$t('m.others15')}}</i>
                    </router-link>
                  </div>
                  <div class="date_02">
                    <router-link :to="{name:'feedbackdetail',params:{id:item.id}}">
              ...
              <!-- <div class="index-more" v-show="this.list3.length>6">
                <span>more</span>
                <img src="../../assets/images/more-icon.jpg" alt />
              </div> -->
            </div>
...
.book-list ul li .date {
  display: flex;
  align-items: center;
  flex-direction: column;
  width: 1.28rem;
}
.book-list ul li .date a {
  display: flex;
  align-items: center;
  flex-direction: column;
}
.book-list ul li .date a > span {
  font-size: 0.44rem;
  color: #fff;
...
.date_03 .total-button button span {
  font-size: 0.34rem;
}
.date_03 .total-button .s11 {
  background-color: #fff;
  border: 1px solid #5975a9;
  color: #5975a9;
}
.date_03 .total-button .s22 {
  background-color: #5975a9;
  border: 1px solid #5975a9;
  color: #fff;
}
.date_03 .total-button .s11 span {
  color: #5975a9;
}
.date_03 .total-button .s22 span {
  color: #fff;
}
