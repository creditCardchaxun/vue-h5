...
<div class="bookingfeedback">
    ...
    <div class="message">
      ...
      <div class="feedback">
        ...
        <button class='btns-submit'  @click="showRight"  type='submit' :disabled="isclicks">{{$t('m.feedback5')}}</button>
    ...
    <div class="details">
      <ul>
        ...
        <li style='position:relative'>
          ...
          <img src="../../assets/images/dianhua.png" alt="" style='width:0.6rem;height:0.6rem;position:absolute;right:20px;top:12px;'>
        </li>
        <li>
...
.message ul li .times02{width:7.14rem;}
.message ul li span label{width:auto;height:auto;float: left;  
...
.good p {
 ...
 .feedback .btns-submit{width: 100%;
    height: 1.0rem;
    line-height: 1.0rem;
    color: #fff;
    text-align: center;
