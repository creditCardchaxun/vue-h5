  ...
  <div class="myReserve">
    ...
    <div class="myreserve">
      <van-cell-group>
        ...
        <div class="phones">
          <van-field v-model="phone" :placeholder="$t('m.s1')" :label="$t('m.s1')" readonly />
...
.names >>> .van-cell:not(:last-child)::after {
  border-bottom: none;
}
.phones {
  position: relative;
...
.timesall .van-cell .van-cell__value {
  width: 50% !important;
}
.timesall >>> .van-cell:not(:last-child)::after {
  border-bottom: none;
}
</style>