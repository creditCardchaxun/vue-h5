<template>
  <div class="hotel-detail">
    ...
    <div class="desc">
      <h3>公寓特色</h3>
      <p v-if="projectdetail.desc!=''">{{projectdetail.desc}}</p>
    ...
    <div class="types">
      ...
      <div class="desc">
        ...
        <ul
          v-if="projectdetail.project_setting!=''"
          ref="heightShow"
        ...
        <div
          class="nolist"
          v-else
          style="font-size:0.35rem;text-align:center;margin:0.3rem 0;"
        >暂无公寓配置详细信息</div>
