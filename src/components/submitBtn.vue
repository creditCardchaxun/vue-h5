...
.mains input[disabled]{background-color: #fff;}
/* .mains button{} */
...
.btns-sub{
    ...
    width:80%;height:1.0rem;
    line-height:1.0rem;
    color:#fff;
    text-align: center;
    background-color: #5975a9;
    font-size:0.3rem;border:none;
    margin:0 auto;
    margin-left:10%;
    border-radius: 0.1rem;
    margin-top:1.2rem;
    ...
    .mains .btnVerfity{
     width:2.37rem;height:0.8rem;font-size:0.3rem;position:absolute;right:-11px;bottom:16px;background-color: #5975a9;border:none;color:#fff;
    }
     .btnVerfity[disabled] {
      background-color: #dddddd;
      color:#333;
