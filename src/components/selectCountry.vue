<template>
  ...
  <!-- <van-index-anchor index="A" />
        <van-cell v-for="(item,index) in options" :key="item.value" :title="item.name" >
            {{item.tel}}
        </van-cell> -->
        <!-- <van-index-anchor index="B" />
       <van-cell v-for="(item,index) in options" :key="item.value" :title="item.name" /> -->
...
/* .select{width:2rem;height:1rem;position:absolute;top:0;left:0;} */
 select{width:2rem;height:1rem;}
 .select-country{z-index: 999;position: relative;background: #fff;  }
</style>