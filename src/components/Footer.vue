<template>
  <div class="footer">
       <div class="foot-nav">
        ...
        <router-link :to="{path:'/news'}" replace>{{$t('m.home2')}}</router-link> |
        <router-link :to="{path:'/activity'}" replace>{{$t('m.home3')}} </router-link> |
...
.foot-bottom{width:10.8rem;background-color: #313131;color:rgba(255,255,255,0.2);font-size:0.3rem;line-height:0.43rem; text-align: center;padding:0.34rem 0 0;height:1.5rem;box-sizing: border-box;}
.scrolltop{
    width: 1rem;
    height:1rem;
    border-radius: 50%;
