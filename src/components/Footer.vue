<template>
  <div class="footer">
       <div class="foot-nav">
         <div class="foot">
        <router-link :to="{path:'/hotel'}">{{$t('m.homebottom')}}</router-link> |
        <router-link :to="{path:'/news'}">{{$t('m.home2')}}</router-link> |
        <router-link :to="{path:'/activity'}">{{$t('m.home3')}} </router-link> |
        <router-link :to="{name:'contact',params:{active:0}}">{{$t('m.home5')}}</router-link>
        </div>
        <div class="foot_01">
            <ul>
...
.foot-nav{width:100%;background-color: #3c5896;color:#fff;}
...
.foot-bottom{width:100%;background-color: #313131;color:rgba(255,255,255,0.2);font-size:0.3rem;line-height:0.43rem; text-align: center;padding:0.37rem 0 0.48rem;}
.scrolltop{
    width: 1rem;
    height:1rem;
    border-radius: 50%;
...
.kefu .kefu_01 .kefu-04{width:1.8rem;height:1.18rem;display: flex;align-items: left;font-size:0.35rem;flex-direction: column;justify-content: center;}
.kefu .kefu_01 .kefu-04 span{color:#fff;font-size:0.34rem;line-height: 0.4rem;}
.kefu .kefu_01 .kefu-04 .kefu_time{color:#fff;font-size:0.28rem;}
</style>