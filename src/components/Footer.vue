...
<style scoped>
.footer{height:5.96rem; position:absolute;bottom:0;width:100%;}
.foot-nav{width:100%;background-color: #3c5896;color:#fff;height:4.45rem;}
...
.foot_01{width:auto;height:auto;margin:0 1.05rem;}
...
.foot-bottom{width:100%;background-color: #313131;color:rgba(255,255,255,0.2);font-size:0.3rem;line-height:0.43rem; text-align: center;padding:0.34rem 0 0;height:1.5rem;box-sizing: border-box;}
.scrolltop{
    width: 1rem;
    height:1rem;
    border-radius: 50%;
