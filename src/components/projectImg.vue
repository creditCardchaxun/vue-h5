...
.pro-item .pro-items .project-img {
  width: 100%;
  height: 8rem;
...
.pro-item .pro-items .project-img .pro-img {
  width: 3.35rem;
  height: 0.99rem;
  margin: 0 0.73rem;
}
.pro-item .pro-items .project-img .pro-img img {
  width: 100%;
  height: auto;
}
.pro-item .pro-items .project-img .pro-main {
...
.pro-item .pro-items .project-img .pro-main span {
  font-size: 0.36rem;
  color: #fff;
}
...
.pro-item .pro-items .project-img p {
  font-size: 0.35rem;
  line-height: 0.54rem;
  color: #fff;
  margin: 0.57rem 0.73rem 0;
  text-indent: 0.6rem;
}
.main-other {
  display: flex;
