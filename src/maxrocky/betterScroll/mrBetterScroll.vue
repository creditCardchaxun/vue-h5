      ...
      >
        <div class="pullup-wrapper" v-if="pullUpLoad">
          <div class="before-trigger" v-if="!isPullUpLoad">
            <span style="font-size: .28rem;">{{pullUpTxt}}</span>
          </div>
    ...
    >
      <div ref="pulldown" class="pulldown-wrapper" :style="pullDownStyle" v-if="pullDownRefresh">
        ...
        <div class="after-trigger" v-else>
          ...
          <div v-else><span style="font-size: .28rem;">{{refreshTxt}}</span></div>
        </div>
      </div>
    </slot>
  </div>
...
export default {
  ...
  activated () {
    this.scroll && this.scroll.scrollTo(this.cacheX || 0, this.cacheY || 0, 0)
  },
  deactivated () {
    this.cacheX = this.scroll.x
    this.cacheY = this.scroll.y
  },
  computed: {
    pullUpTxt () {
  ...
  methods: {
    ...
    _initPullDownRefresh () {
      ...
      this.scroll.on('scroll', (pos) => {
        ...
        // }
        // this.oldY = pos.y
        // console.log(pos.y, this.pullDownInitTop)
        if (this.beforePullDown) {
          let bubbleY = pos.y + this.pullDownInitTop
          if (bubbleY > -50) {
    ...
    _reboundPullDown () {
      ...
      return new Promise((resolve) => {
        setTimeout(() => {
          ...
          // this.scroll.startY = 0 // UPDATE: 下拉后页面高度置0
          resolve()
        }, stopTime)
      })
    },
